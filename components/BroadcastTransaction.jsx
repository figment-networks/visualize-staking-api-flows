      ...
      >
        ...
        >
          <ul>
            ...
            <li>
              <b>
                When the signed transaction payload is sent to the Staking API,
            ...
            <li>
              If you are interested in going further, learn how to set up
              webhooks to be notified of Staking API actions in the{" "}
              <Link
                target="_blank"
