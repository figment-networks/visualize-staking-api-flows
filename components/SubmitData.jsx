...
import { Row, Col, Button, Modal, ConfigProvider, Steps, Tooltip } from "antd";
import {
  WarningOutlined,
  SolutionOutlined,
  CheckCircleOutlined,
              ...
              <>
                <p className={styles.desc}>
                  ...
                  <Tooltip
                    ...
                    title={`Using the flowId in the endpoint URL like this: /api/v1/flows/${flowId}/next`}
                    arrowPointAtCenter
                  >
        ...
        >
          <ul>
            ...
            <li>
              <details>
                <summary>
                  Click here to see the full Staking API response
                </summary>
                <ul>
                  <li>
                  ...
                  <li>
                    Action Display Label: <b>{flowLabels.join(", ")}</b> come
                    from <code>actions[0].inputs[0].display</code>,{" "}
            ...
            <li>
              ...
              <details>
                ...
                <p style={{ padding: "10px" }}>
                  ...
                  information needed by the Staking API to create the
                  transaction payload:
                </p>
