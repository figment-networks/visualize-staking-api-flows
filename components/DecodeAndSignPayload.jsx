        ...
        >
          ...
          >
            <ul>
              ...
              <li>
                In this context, the private key being used to sign the
                transaction is the one generated by this app. This is not a
                production-grade pattern for handling private keys, and the code
                in this repository is intended solely for educational purposes.
              </li>
              <br />

              <li>
                When the signature is applied to the payload, it can then be
                returned to the Staking API in its signed state. This allows the
                Staking API to submit the signed payload to the blockchain and
                complete the flow.
              </li>
              <br />
            </ul>
          ...
          <div className="row">
            <p className={styles.description}>
              After submitting the delegation data, the next step is to sign the
              unsigned <code>transaction_payload</code> below.
              <br />
              <br />
              We can decode it first, using <code>@figmentio/slate</code> to
