...
import { Col, Row, Button, Modal, ConfigProvider, Steps, Tooltip } from "antd";
import {
  WarningOutlined,
  SolutionOutlined,
  CheckCircleOutlined,
            ...
            {decodedTransactionPayload &&
              ...
              stepCompleted === 2 && (
                <>
                  ...
                  <p>
                    These are the values you submitted to the Staking API for
                    this delegation in the previous step:
                    <br />
                    <br />
        ...
        >
          <ul>
            ...
            <li>
              ...
              . The prefix is part of the string representation of the public
              key &mdash; however this is not maintained when the public key is
              added to the NEAR Transaction object as a byte array. Just be
              aware that an <b>ed25519</b> public key contains 32 bytes which
              map to a 64 character account ID (on NEAR this is what&apos;s
              known as an <b>implicit account</b>).
              <details>
                <summary>
