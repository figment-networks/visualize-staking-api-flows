...
export const LayoutVertical = ({ children }) => (
  <div>
    <style jsx>{`
      div {
        position: relative;
...
export const LayoutColumn = ({ children, title }) => (
...
LayoutColumn.Column = ({ children, ...props }) => (
  <div className="column" {...props}>
    {children}
  </div>
);

LayoutColumn.Column.displayName = "Column";
